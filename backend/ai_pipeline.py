...
class AIProcessor:
    ...
    def generate_text_sticker_prompts(self, user_input, tone="random"):
...
- Captions must be REACTIONS/EXPRESSIONS you'd actually send in a WhatsApp chat
- Think: What would someone TYPE when sending this sticker?
- NOT descriptive labels like "Shopping", "Working", "Eating"
- YES reactions like: "Take my money", "Broke again", "Need this", "Same tbh", "Why tho", "Slay", "Mood", "Vibe check"
...
"""
    ...
    def process_text_sticker_generation(self, user_input, job_id, tone="random", progress_callback=None):
        ...
        # Generic prompts - topic-focused, cute illustrated style
        generic_prompts = [
            {
                "id": "gen_1", 
                "caption": "let's goooo", 
        ...
        # Parallel: Call OpenAI for smart prompts
        plan = self.generate_text_sticker_prompts(user_input, tone)
